...
export function Button({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative bg-slate-900/[0.8] border border-slate-800 backdrop-blur-xl text-white flex items-center justify-center w-full h-full px-6 py-3 text-sm antialiased z-[20]",
          className
        )}
        style={{
